    ...
    <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
      <div className="group flex gap-x-2 items-start w-full">
        ...
        <div className="flex flex-col w-full">
          ...
          {isPDF && (
            <div className="relative flex w-fit items-center p-2 px-3 mt-2 rounded-md bg-background/10">
          ...
          {canEditMessage && (
            <ActionTooltip label="Edit">
              <Edit
                ...
                className="cursor-pointer ml-auto size-4 text-zinc-50 hover:text-zinc-600 dark:hover:text-zinc-300 transition"
              />
            </ActionTooltip>
          )}
